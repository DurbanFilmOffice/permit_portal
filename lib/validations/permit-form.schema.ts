...
export const permitFormSchema = z.object({
  ...
  formData: z.object({
    ...
    requiresSfxPermit:       z.enum(['yes', 'no'], { required_error: 'SFX permit answer is required' }),
    ...
    requiresTrafficControl:      z.enum(['yes', 'no'], { required_error: 'Traffic control answer is required' }),
    ...
    involveDroneFilming:         z.enum(['yes', 'no'], { required_error: 'Drone filming answer is required' }),
